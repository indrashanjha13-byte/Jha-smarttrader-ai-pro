...
def get_kotak_atm_contract(
    ...
    try:
        ...
        # ====================================================
        # ACTUAL KOTAK RESOLVER STRUCTURE
        #
        # {
        #   index: NIFTY,
        #   underlying_price: ...,
...
def process_trade_compatible(
    ...
    This keeps dashboard.py compatible with older/newer
    TradeManager versions.
    """
    ...
    try:
        ...
        # ----------------------------------------------------
        # If **kwargs is supported, send everything.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Otherwise only supported parameters.
        # ----------------------------------------------------
...
if page == "🏠 Dashboard":
    ...
    if (
        ...
        # EXACT OPTION LTP
        #
        # Kotak resolver = contract master only.
        # LTP = existing option-chain source.
        # ====================================================
